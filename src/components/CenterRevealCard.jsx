...
<BodyLine>
              ...
              <BodyLine>
                Большой опыт работы с топовыми артистами и селебрити-блогерами.
              </BodyLine>
...
function BioMobileOverlay({ open, onClose, imageSrc }) {
  ...
  const LINES_ABOVE = 11;      // требуемые 5 строк
      ...
      >
        ...
        <img
          ...
          style={{
            ...
            height: "100%",
            objectFit: "cover",
            objectPosition: "90% 22%"  // ← как просил
          }}
        />
...
{/* BIO — как на Desktop: Royal Crescent (400) */}
...
{/* Showreel — как на Desktop: Royal Crescent (400) */}
<PrePlate active={true}>
  <h3
    data-sr
    style={{
...
>
  {[1,2,3].map((n,idx)=>(
    ...
    >
     ...
     {/* Соц-иконки — прижаты к низу, с отступом 12px */}
<div
  style={{
    position: "fixed",
    left: "50%",
